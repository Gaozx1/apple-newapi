...
const createModelSchema = (t: Translate) =>
  z.object({
    ...
    ImageSizePrice: createJsonStringField(t),
...
export function RatioSettingsCard({
  ...
  const modelNormalizedDefaults = useRef({
    ...
    ImageSizePrice: normalizeJsonString(modelDefaults.ImageSizePrice),
  ...
  const modelForm = useForm<ModelFormValues>({
    ...
    defaultValues: {
      ...
      ImageSizePrice: formatJsonForTextarea(modelDefaults.ImageSizePrice),
  ...
  const saveModelRatios = useCallback(
    async (values: ModelFormValues) => {
      const normalized = {
        ...
        ImageSizePrice: normalizeJsonString(values.ImageSizePrice),
