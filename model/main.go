...
` + "`model_quotas`" + ` text,
` + "`model_token_quotas`" + ` text,
` + "`usable_groups`" + ` varchar(512) DEFAULT '',
...
PRIMARY KEY (` + "`id`" + `)
	...
	required := []sqliteColumnDef{
		...
		{Name: "model_quotas", DDL: "`model_quotas` text"},
		{Name: "model_token_quotas", DDL: "`model_token_quotas` text"},
		{Name: "usable_groups", DDL: "`usable_groups` varchar(512) DEFAULT ''"},
